...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="EquivalenceExperiment", description="test equivalence of LID-CMC in converting operators"
    )
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument('--all', action='store_true', help="Test all operators test cases in the dataset.")
    group.add_argument('--single_operator', metavar='OPERATOR', help="Tests the test case of one of the selected operators.")
